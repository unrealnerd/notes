...
anoher alternate way to use different ssh keys is `GIT_SSH_COMMAND="ssh -i ~/.ssh/key" git clone  --no-checkout <ssh repo url>`
...
- update this in the project `.github\config` file 
    ```
    [remote "origin"]
	url = https://unrealnerd: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@github.com/Eubrics/leadx.git
