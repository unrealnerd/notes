...
- Redemption protocol - server/origin ask to challenge/present the token from the client. Client may respond with the previously obtained token based on the token attributes (validity, same origin , etc.)
